...
TARGET = os.path.join(ROOT, "client", "src", "pages", "Goals.tsx")
...
const GOAL_ICONS = ["\U0001f3af", "\U0001f4b0", "\U0001f3e0", "\u2708\ufe0f", "\U0001f697", "\U0001f4f1", "\U0001f48d", "\U0001f393", "\U0001f3e5", "\U0001f381"];
...
export default function Goals() {
  ...
  const [formData, setFormData] = useState({
    ...
    icon: "\U0001f3af", color: "#3B82F6", linkedCategoryId: "",
  });
  ...
  const resetForm = () => {
    setDialogOpen(false);
    setEditingGoal(null);
    setFormData({ name: "", targetAmount: "", targetDate: "", icon: "\U0001f3af", color: "#3B82F6", linkedCategoryId: "" });
    setFormErrors({});
  };
                ...
                <CardHeader className="pb-2">
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-2">
                      <span className="text-2xl">{goal.icon || "\U0001f3af"}</span>
